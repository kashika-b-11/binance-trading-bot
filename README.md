...
Setup Instructions
1. Clone Repository
bashgit clone https://github.com/kashika-b-11/binance-trading-bot.git
...
Market Order:
bashpython cli.py --symbol BTCUSDT --side BUY --order-type MARKET --quantity 0.01
Limit Order:
bashpython cli.py --symbol BTCUSDT --side BUY --order-type LIMIT --quantity 0.01 --price 30000
Stop-Market Order:
bashpython cli.py --symbol BTCUSDT --side SELL --order-type STOP_MARKET --quantity 0.01 --stop-price 29000
Stop-Limit Order (Bonus):
bashpython cli.py --symbol BTCUSDT --side SELL --order-type STOP --quantity 0.01 --stop-price 29000 --price 28500

Interactive Menu Mode (Bonus)
Run without flags to get a fully guided step-by-step prompt:
bashpython cli.py --interactive
```
...
git commit -m "docs: update README with all bonus features"
git push origin main
That's it! ✅ Sonnet 4.6Claude is AI and can make mistakes. Please double-check re
